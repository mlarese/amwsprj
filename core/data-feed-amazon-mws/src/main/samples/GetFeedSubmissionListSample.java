...
public class GetFeedSubmissionListSample {
    ...
    public static void main(String... args) {
         ...
         * http://aws.amazon.com
         ***********************************************************************/
        final String accessKeyId = "AKIAJTQYXL27XBWPYE6Q";

        final String secretAccessKey = "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";

        final String appName = "OIR";
         ...
         ***********************************************************************/
        final String merchantId = "AY1M7XWOMCSAI";
